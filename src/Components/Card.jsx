  ...
  return (
    <>
      <div className="w-full md:w-[273px] shrink-0 mb-3">
        ...
        <div>
          <Star className="inline" /><span className="font-bold">{props.rating}</span><LuDot  className="inline"/>
          <span className=" font-bold">{props.minTime} - {props.maxTime} mins </span>
        </div>
        <div className="text-slate-800">
          <span className="font-medium">{props.name}</span><br/>
          <span className="font-medium">{props.place}</span>
        </div>
      </div>
    </>
  );
